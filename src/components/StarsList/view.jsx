	...
	return (
		<div className="stars-list">
			<div className="stars-list-header">
				...
				<span className="stars-list-header-text">{percentage}% → {formatNumber(resources.hydrogen * percentage / 100)}</span>
				<input type="button" value="Form protostar" className="stars-list-form" onClick={formStar} />
			</div>
		</div>
	);
}